...
import data from './../latinen.json';
import pnuemo from './../images/pneumo.png';

export default class Latinen extends Component {
    ...
    render() {
        return (
            <React.Fragment>
                <Header.H4>ÍNDICE DE LATTINEN (IL)</Header.H4>
                <Card>
                    <CardHeader
                        title={"Prueba"}
                    />
                    <Card.Body>
                        <div className="row">
                            <div className={`col-sm-12 col-md-12 col-lg-12 col-xl-12`}>
                                <SuperInput field={data.fecha} />
                            </div>
                        </div>
                        {
                            this.getChunksOf(data.latinen, 1).map((chunk, i) =>
